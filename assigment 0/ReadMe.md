...
The term data mining is used to describe the whole KDD process because it is the stage where useful results like patterns and predictions are actually found. This part gets the most attention, while earlier steps such as cleaning and preparing the data are not usually noticed. The phrase data mining is short and easy to say, unlike knowledge discovery process, which sounds long and technical. Modern data mining tools also perform several steps together, including cleaning, transforming, and analyzing data. Since all these tasks happen in one system, the whole process is commonly referred to as data mining.
⸻
